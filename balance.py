...
if __name__ == "__main__":
    ...
    for i in range(5):
        idx = np.random.choice(len(train_img[train_races==i]), num_sample, replace=True)
    ...
    torch.save(best_model, 'checkpoint/balance.pt')
    ...
    for i in range(5):
        ...
        loss.append(get_performance_test(best_model, data_loader, 'cuda'))
    print(loss)
